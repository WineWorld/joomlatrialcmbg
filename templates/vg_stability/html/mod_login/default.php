...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" class="form-inline">
	...
	<?php endif; ?>
	<div class="userdata">
		<div id="form-login-username" class="input-group input-group-lg">
			<div class="controls">
		...
		<div id="form-login-password" class="input-group input-group-lg">
			<div class="controls">
				<?php if (!$params->get('usetext')) : ?>
					<div class="input-prepend">
		...
		<div id="form-login-submit" class="input-group input-group-lg">
			<div class="controls">
