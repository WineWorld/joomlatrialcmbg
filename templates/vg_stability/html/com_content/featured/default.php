...
<div class="items-leading clearfix">
	<?php foreach ($this->lead_items as &$item) : ?>
        ...
        <article class="entry <?php echo $images->image_intro_caption != '' ? ' entry__standard entry__with-icon' : ''; ?>">
...
<?php if (!empty($this->intro_items)) : ?>
	<?php foreach ($this->intro_items as $key => &$item) : ?>
		...
		<div class="items-row col-<?php echo (int) $this->columns; ?> <?php echo 'row-' . $row; ?> row clearfix">
		<?php endif; ?>
