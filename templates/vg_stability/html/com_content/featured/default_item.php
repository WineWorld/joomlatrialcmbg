...
<?php if( $images->image_intro_caption ): ?>
    <div class="entry-icon visible-md visible-lg">
        <i class="fa <?php echo htmlspecialchars($images->image_intro_caption); ?>"></i>
    </div>
<?php endif; ?>
...
<?php if ($params->get('show_readmore') && $this->item->readmore) :
	...
	<p class="readmore"><a class="btn btn-default btn-sm" href="<?php echo $link; ?>" itemprop="url"> <span class="icon-chevron-right"></span>
