...
if( $images->image_fulltext_caption ):
    $icon_class_ = 'entry__standard entry__with-icon';
else:
    $icon_class_ = '';
endif;
?>
<article class="entry <?php echo $icon_class_; ?>">

<?php if( $images->image_fulltext_caption ): ?>
    <div class="entry-icon visible-md visible-lg">
        <i class="fa <?php echo htmlspecialchars($images->image_fulltext_caption); ?>"></i>
    </div>
<?php endif; ?>
...
?>
		...
		<?php if ($canEdit || $params->get('show_print_icon') || $params->get('show_email_icon')) : ?>
            <div class="pull-right">
                <?php if ($params->get('show_print_icon')) : ?>
                    <i class="fa fa-print"></i> <?php echo JHtml::_('icon.print_popup', $this->item, $params); ?> 
                <?php endif; ?>
                <?php if ($params->get('show_email_icon')) : ?>
                    <i class="fa fa-envelope"></i> <?php echo JHtml::_('icon.email', $this->item, $params); ?> 
                <?php endif; ?>
                <?php if ($canEdit) : ?>
                    <i class="fa fa-edit"></i> <?php echo JHtml::_('icon.edit', $this->item, $params); ?> 
                <?php endif; ?>
            </div>
		<?php endif; ?>
	<?php else : ?>
	...
	<figure class="align<?php echo htmlspecialchars($imgfloat); ?> entry-thumb">
        ...
        <?php echo 'class="caption-image"'.' title="' .htmlspecialchars(strip_tags($this->item->title)) . '"'; ?>
